		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
			...
			>
				...
				<p class="text-sm text-blue-700 mt-1">
					Your payment method will be securely saved for future
					purchases.
				</p>
			</div>
			...
			<div class="space-y-3">
				...
				>
					...
					<div class="ml-3">
						...
						>
						<p class="text-xs text-slate-500">
							User selects from their saved PayPal addresses
						</p>
					</div>
				</label>
			</div>
			...
			>
					ℹ️ This address will be prefilled in PayPal checkout but can be
							...
							{#if payerEmail}
								<p class="text-sm">
									<span class="font-semibold text-slate-700"
										>Payer Email:</span
									>
									<span class="ml-2">{payerEmail}</span>
								</p>
							{/if}
						</div>
						<p
